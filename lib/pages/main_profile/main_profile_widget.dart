      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          ...
          floatingActionButton: FloatingActionButton(
            onPressed: () async {
              _model.apiResult8k9 = await LyfieCall.call(
                phoneNumber: mainProfileUsersRecord.phoneNumber,
                name: mainProfileUsersRecord.displayName,
                foodPreference: mainProfileUsersRecord.foodPreference,
                bio: mainProfileUsersRecord.bio,
              );
              ...
              await showDialog(
                ...
                builder: (alertDialogContext) {
                  return AlertDialog(
                    title: Text('Call Triggered !'),
                    content: Text('Lyfie is gonna call you..'),
                    actions: [
                      TextButton(
            ...
            child: ClipRRect(
              ...
              child: Image.asset(
                'assets/images/WhatsApp_Image_2024-10-29_at_00.35.19_b9fe8752-removebg-preview.png',
                width: 34.0,
                height: 33.0,
                fit: BoxFit.fill,
              ),
