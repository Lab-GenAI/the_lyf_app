...
import 'happy_halloween_model.dart';
export 'happy_halloween_model.dart';

class HappyHalloweenWidget extends StatefulWidget {
  const HappyHalloweenWidget({super.key});

  @override
  State<HappyHalloweenWidget> createState() => _HappyHalloweenWidgetState();
}

class _HappyHalloweenWidgetState extends State<HappyHalloweenWidget>
    with TickerProviderStateMixin {
  late HappyHalloweenModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HappyHalloweenModel());
                      ...
                      children: [
                        ...
                        Container(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              context.pushNamed('HalloweenTicket');
                            },
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
