    ...
    GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/myMainPage',
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'MyMainPage')
              : MyMainPageWidget(),
        ),
        FFRoute(
          name: 'HappyHalloween',
          path: '/happyHalloween',
          builder: (context, params) => HappyHalloweenWidget(),
        ),
        FFRoute(
          name: 'HalloweenTicket',
          path: '/halloweenTicket',
          builder: (context, params) => HalloweenTicketWidget(),
        ),
        FFRoute(
          name: 'currentbooking',
          path: '/currentbooking',
          builder: (context, params) => CurrentbookingWidget(),
        ),
        FFRoute(
          name: 'Sociosbylyf',
          path: '/sociosbylyf',
          builder: (context, params) => SociosbylyfWidget(),
        ),
        FFRoute(
          name: 'HackGlobal',
          path: '/hackGlobal',
          builder: (context, params) => HackGlobalWidget(),
        ),
        FFRoute(
          name: 'SwitchTicket',
          path: '/switchTicket',
          builder: (context, params) => SwitchTicketWidget(),
        )
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Image.asset(
                    'assets/images/WhatsApp_Image_2024-10-27_at_17.54.14_cc97d1d4.jpg',
                    fit: BoxFit.cover,
                  ),
                )
              : page;
